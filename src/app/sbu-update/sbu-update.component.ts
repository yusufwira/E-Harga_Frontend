...
@Component({
  selector: 'app-sbu-update',
  templateUrl: './sbu-update.component.html',
  styleUrls: ['./sbu-update.component.scss']
})
export class SbuUpdateComponent implements OnInit {

  constructor(public db:SbuServiceService,public route:ActivatedRoute,private router: Router,private dialogService: NbDialogService) { }
