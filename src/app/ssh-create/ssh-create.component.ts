...
@Component({
  selector: 'app-ssh-create',
  templateUrl: './ssh-create.component.html',
  styleUrls: ['./ssh-create.component.scss']
})
export class SshCreateComponent implements OnInit {

  constructor(public db:DatabaseServiceService,private router: Router,private dialogService: NbDialogService) { }
  survey1=0;
  survey2=0;
  survey3=0;
  survey4=0;
  ...
  inputAlasan(event:any){
    ...
    this.db.postSSH(this.kode,this.nama)
     .subscribe((data) => {
          console.log(data);
