...
@Component({
  selector: 'app-sbu-create',
  templateUrl: './sbu-create.component.html',
  styleUrls: ['./sbu-create.component.scss']
})
export class SbuCreateComponent implements OnInit {


  constructor(public db:SbuServiceService,private router: Router,private dialogService: NbDialogService) { }
  ngOnInit() {
  }
  survey1=0;
  survey2=0;
  ...
  inputAlasan(event:any){
    ...
    this.db.alasan = this.alasan
		...
		this.db.postSBU(this.kode,this.nama)
 		.subscribe((data) => {
